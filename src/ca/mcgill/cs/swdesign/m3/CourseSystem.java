...
public class CourseSystem {
    ...
    public static void enrollAndRankStudent() {
        ...
        comp303.setStudentComparator(new Comparator<Student>() {
            @Override
    ...
    private static CourseSchedule createSchedule() {
        ...
        LocalTime startTime = LocalTime.of(13,05,00);
        LocalTime endTime  = LocalTime.of(14,25,00);

        CourseSchedule toReturn =  new CourseSchedule(Semester.getSemester(Semester.Term.Winter, 2023), pDayOfWeek,
                startTime, endTime);
        return toReturn;
    }
