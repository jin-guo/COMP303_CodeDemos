...
public class Line implements Shape {
    ...
    public Line(int x_start, int y_start, int x_end, int y_end) {
        assert x_start>0 && y_start>0 && x_end>0 && y_end>0;
    ...
    public static Line makeCopy(Line pShape) {
        return new Line(pShape);
    }



    /**
     * Create and return a command object that implements the KeyboardShortcut interface.
    ...
    public KeyboardShortcut getMoveShortcut(int x, int y) {
        return new KeyboardShortcut() {
            private int pre_x_start=0;
            private int pre_y_start=0;
            private int pre_x_end=0;
            private int pre_y_end=0;
